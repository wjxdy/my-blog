...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        // 数据库连接配置（请确认库名和表存在）
        String url = "jdbc:mysql://localhost:3306/library?useUnicode=true&characterEncoding=utf-8&serverTimezone=Asia/Shanghai";
        String username = "root";
        String password = "Xulei20040831";

        // 必须指定要生成的表名（替换为你的实际表名，如"user","article"）
        String[] tables = {"ad", "ad_type","article","article_tag","article_tag_list","comment","comment_reply","link","reader"}; // 例如：{"book", "user"}
